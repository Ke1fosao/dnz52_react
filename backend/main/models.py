...
# ============================================================================
# Налаштування ШІ (singleton) — авто-модерація відгуків тощо
# ============================================================================
class AISettings(models.Model):
    """Перемикачі ШІ-функцій. Один запис (singleton)."""
    auto_moderate_reviews = models.BooleanField(
        'Авто-модерація відгуків ШІ', default=False,
        help_text='Якщо увімкнено — нові відгуки автоматично перевіряються ШІ: '
                  'коректні публікуються одразу, підозрілі (лайка, погрози тощо) '
                  'відкладаються на ручну модерацію.',
    )
