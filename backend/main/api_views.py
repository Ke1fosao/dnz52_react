...
def _chat_ambient():
    ...
    # Структура сайту
    parts.append(
        'Корисні сторінки сайту (можеш давати посилання на них батькам):\n'
        '• Віртуальний тур (3D-прогулянка садочком): сторінка /tour\n'
        '• Електронна заявка на зарахування до ЗДО: сторінка /enrollment\n'
        '• Про заклад (історія, місія): сторінка /about\n'
        '• Керівництво та адміністрація: сторінка /staff\n'
        '• Атестація працівників: сторінка /attestation\n'
        '• Офіційні документи закладу: сторінка /documents\n'
        '• Корисна інформація для батьків: сторінка /parents\n'
        '• Часті запитання та відповіді (FAQ): сторінка /faq\n'
        '• Відгуки батьків про садочок: сторінка /reviews\n'
        '• Гуртки та секції (творчість, розвиток): сторінка /circles\n'
        '• Галерея (фото та відео): сторінка /gallery'
    )
