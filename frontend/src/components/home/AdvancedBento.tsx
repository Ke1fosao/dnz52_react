    ...
    <section className="py-20 md:py-24 relative">
      <div className="container mx-auto px-4 max-w-7xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-6 gap-5 md:gap-6 auto-rows-[230px]">
          {/* Групи — велика картка */}
          <Reveal variant="fade-up" delay={0.05} className="md:col-span-4 md:row-span-2">
            <TiltCard className="h-full" max={5}>
              <Link to="/groups" className="clay-card h-full p-8 md:p-10 relative overflow-hidden group flex flex-col justify-end !rounded-[2.5rem] bg-gradient-to-br from-indigo-500 via-violet-500 to-fuchsia-500 dark:from-indigo-700 dark:via-violet-800 dark:to-fuchsia-900 block">
          ...
          {/* Меню */}
          <Reveal variant="fade-up" delay={0.1} className="md:col-span-2">
            <TiltCard className="h-full" max={6}>
              <Link to="/menu" className="clay-card h-full p-7 relative overflow-hidden group bg-gradient-to-br from-orange-100 to-orange-200 dark:!from-slate-800 dark:!to-slate-800 !rounded-[2.5rem] block">
          ...
          {/* Контакти */}
          <Reveal variant="fade-up" delay={0.15} className="md:col-span-1">
            <TiltCard className="h-full" max={8}>
              <Link to="/contacts" className="clay-card h-full p-7 relative overflow-hidden group bg-gradient-to-br from-emerald-100 to-teal-200 dark:!from-slate-800 dark:!to-slate-800 !rounded-[2.5rem] block">
          ...
          {/* Галерея */}
          <Reveal variant="fade-up" delay={0.2} className="md:col-span-1">
            <TiltCard className="h-full" max={8}>
              <Link to="/gallery" className="clay-card h-full p-7 relative overflow-hidden group bg-gradient-to-br from-pink-100 to-rose-200 dark:!from-slate-800 dark:!to-slate-800 !rounded-[2.5rem] block">
          ...
          {/* Батькам */}
          <Reveal variant="fade-up" delay={0.1} className="md:col-span-3">
            <TiltCard className="h-full" max={4}>
              <Link to="/parents" className="h-full relative overflow-hidden group bg-slate-900 rounded-[2.5rem] shadow-[0_20px_50px_rgba(0,0,0,0.3)] transition-all duration-500 hover:scale-[1.01] hover:-translate-y-2 block">
          ...
          {/* Новини */}
          <Reveal variant="fade-up" delay={0.15} className="md:col-span-3">
            <TiltCard className="h-full" max={4}>
              <Link to="/news" className="clay-card h-full p-7 md:p-8 relative overflow-hidden group bg-gradient-to-br from-sky-100 to-indigo-200 dark:!from-slate-800 dark:!to-slate-800 !rounded-[2.5rem] block">
