...
import {
  ...
  ExternalLink, Menu as MenuIcon, X,
} from 'lucide-react';
...
const NAV: { to: string; label: string; icon: typeof LayoutDashboard; end?: boolean; badge?: 'pending_reviews' | 'new_questions' }[] = [
  { to: '/manage', label: 'Дашборд', icon: LayoutDashboard, end: true },
          ...
          <div className="premium-glass rounded-[1.8rem] h-full lg:h-[calc(100vh-2rem)] lg:sticky lg:top-4 flex flex-col p-5">
            ...
            <nav className="flex flex-col gap-1.5 flex-1">
              ...
              <a href={DJANGO_ADMIN} target="_blank" rel="noreferrer"
                className="flex items-center gap-3 px-4 py-3 rounded-2xl font-bold text-gray-500 dark:text-slate-400 hover:bg-white/50 dark:hover:bg-slate-800/50 mt-2">
