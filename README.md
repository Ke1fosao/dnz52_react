...
- **🤖 ШІ-чат-помічник «Сонечко»** — відповідає батькам на запитання про садочок (Google Gemini + контекст із сайту, з посиланнями на джерела).
- **📝 Онлайн-заявка на зарахування** — подати заявку на зарахування дитини онлайн (валідація, згода на обробку даних, антиспам).
- **🏫 Віртуальний тур** — імерсивна прогулянка садочком по зупинках (фото + опис, навігація стрілками / свайпом / мініатюрами).
...
- Новини, події, FAQ, документи, **галерея** (масове завантаження + поворот фото), меню + шаблон тижня,
  ...
  **заявки на зарахування** та **віртуальний тур**.
...
| `POST /chat/` | ШІ-чат-помічник (Gemini + контекст із сайту) |
| `POST /enrollment/` | Онлайн-заявка на зарахування |
| `GET /tour/` | Зупинки віртуального туру |
